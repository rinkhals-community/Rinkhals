...
# Before MD5: 0c5ce88260bbd01532ba608ac946109e
# After MD5: 6adcd72fc2ee83b1297c425b7ce79dcc

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "6adcd72fc2ee83b1297c425b7ce79dcc" ]; then
    echo $TARGET is already patched, skipping...
    exit 0
fi
if [ "$MD5" != "0c5ce88260bbd01532ba608ac946109e" ]; then
