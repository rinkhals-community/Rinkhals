...
# Before MD5: 61ef528ac60075a4c2faf5fa0e30a90f
# After MD5: b09121f5012ed13b609a247cd8624e30

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "b09121f5012ed13b609a247cd8624e30" ]; then
    echo $TARGET is already patched, skipping...
    exit 0
fi
if [ "$MD5" != "61ef528ac60075a4c2faf5fa0e30a90f" ]; then
...
dd if=$PATCH_FILE skip=338 ibs=1 of=$TARGET seek=3053112 obs=1 count=16 conv=notrunc # 0x2e9638 / 0x2f9638 > 0x52696e6b68616c730052696e6b68616c
