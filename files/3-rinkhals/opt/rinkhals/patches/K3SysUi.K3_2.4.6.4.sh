...
# After MD5: d4420c99f4bd3e5a8b5e9bcf9b7c1fd9

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "d4420c99f4bd3e5a8b5e9bcf9b7c1fd9" ]; then
...
dd if=$PATCH_FILE skip=329 ibs=1 of=$TARGET seek=1018127 obs=1 count=9 conv=notrunc # 0xf890f / 0x10890f > 0xe3d1d6feeb76fbffea
