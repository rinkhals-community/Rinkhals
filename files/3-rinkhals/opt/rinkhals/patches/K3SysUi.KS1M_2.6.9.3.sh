...
# After MD5: 23cdc2c7f11f7462b235f30b94857bad

TARGET=$1

MD5=$(md5sum $TARGET | awk '{print $1}')
if [ "$MD5" = "23cdc2c7f11f7462b235f30b94857bad" ]; then
...
dd if=$PATCH_FILE skip=0 ibs=1 of=$TARGET seek=1313552 obs=1 count=4 conv=notrunc # 0x140b10 / 0x150b10 > 0x613900ea
